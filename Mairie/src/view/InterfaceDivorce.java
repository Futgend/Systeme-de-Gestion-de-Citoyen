...
public class InterfaceDivorce extends JPanel {
	 ...
	 * Create the panel.
	 */
	public InterfaceDivorce(control control) {
	...
	// initialisation label		
		...
		JLabel sousTitre = new JLabel("ENREGISTREMENT DIVORCE");
		add(sousTitre);
